...
export function StoreFooter() {
  return (
    <footer className="border-t border-[var(--lf-line)] bg-[var(--lf-cream)] text-[var(--lf-ink)]">
      <div className="mx-auto grid max-w-7xl gap-12 px-4 py-16 md:grid-cols-5 md:px-8">
        <div className="space-y-4 md:col-span-2">
          <StoreLogo subline={false} />
          <p className="max-w-md text-sm leading-relaxed text-[var(--lf-muted)]">
        ...
        <div className="space-y-3">
          ...
          <div className="flex flex-col gap-2 text-sm text-[var(--lf-muted)]">
            <Link to="/produtos" className="hover:text-[var(--lf-ink)]">
              Catálogo
            </Link>
            <Link to="/colecoes" className="hover:text-[var(--lf-ink)]">
              Coleções
            </Link>
            <Link
              to="/produtos"
              search={{ categoria: "biquini" }}
              className="hover:text-[var(--lf-ink)]"
            >
              Biquínis
            </Link>
            <Link
        ...
        <div className="space-y-3">
          <h3 className="text-[10px] tracking-[0.2em] uppercase">Institucional</h3>
          <div className="flex flex-col gap-2 text-sm text-[var(--lf-muted)]">
            <Link
            ...
            <Link to="/termos" className="hover:text-[var(--lf-ink)]">
              Termos de uso
            </Link>
            <Link
        ...
        <div className="space-y-3">
          ...
          <div className="space-y-3 text-sm text-[var(--lf-muted)]">
            <a
              href="https://wa.me/5579998165115"
              target="_blank"
              rel="noreferrer"
              className="flex items-center gap-2 hover:text-[var(--lf-ink)]"
            >
      ...
      <div className="border-t border-[var(--lf-line)] px-4 py-5 text-center text-[10px] tracking-[0.14em] text-[var(--lf-muted)] uppercase">
