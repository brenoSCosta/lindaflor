...
function HomePage() {
  ...
  return (
    <StoreLayout>
      <JsonLd data={[storeJsonLd.organization(), storeJsonLd.website()]} />
      <section className="relative min-h-[85vh] overflow-hidden">
        ...
        />
        <div className="absolute inset-0 bg-linear-to-t from-[color-mix(in_oklab,var(--lf-ink)_55%,transparent)] via-[color-mix(in_oklab,var(--lf-ink)_10%,transparent)] to-transparent" />
        <div className="relative mx-auto flex min-h-[85vh] max-w-7xl items-end px-4 pb-16 md:px-8 md:pb-24">
          <div className="max-w-xl space-y-6 text-white">
            ...
            <p className="max-w-md text-sm leading-relaxed text-white/80 md:text-base">
              Peças pensadas para quem ama sol, mar e estilo. Do biquíni
              clássico à saída de praia perfeita, tudo com a assinatura Linda
              Flor.
            </p>
            <div className="flex flex-wrap gap-3 pt-2">
              <Link to="/produtos">
                <Button className="h-12 rounded-none bg-(--lf-pink) px-8 text-[10px] tracking-[0.2em] text-white uppercase hover:bg-(--lf-pink-deep)">
                  Comprar agora
      ...
      <section className="mx-auto max-w-7xl px-4 py-20 md:px-8">
        <div className="mb-10">
          ...
          <h2 className="font-display mt-2 text-4xl text-(--lf-ink) md:text-5xl">
            Explore a coleção
          </h2>
        </div>
        <div className="grid gap-4 md:grid-cols-3">
          {categories.map((category) => (
            ...
            >
              ...
              />
              <div className="absolute inset-0 bg-linear-to-t from-[color-mix(in_oklab,var(--lf-ink)_50%,transparent)] to-transparent" />
      ...
      <section className="border-y border-[color-mix(in_oklab,var(--lf-ink)_6%,transparent)] bg-(--lf-cream-dark) px-4 py-20 md:px-8">
        <div className="mx-auto max-w-7xl">
          ...
          {featuredQuery.isLoading ? (
            <p className="text-(--lf-muted)">Carregando destaques…</p>
          ) : (
      ...
      >
        ...
        <div className="space-y-6">
          ...
          <h2 className="font-display text-4xl leading-tight text-(--lf-ink) md:text-5xl">
      ...
      <section id="sobre" className="mx-auto max-w-7xl px-4 py-20 md:px-8">
        <div className="mb-12 text-center">
          ...
          <p className="mx-auto mt-3 max-w-2xl text-(--lf-muted)">
        ...
        {allProductsQuery.isLoading ? (
          <p className="text-center text-(--lf-muted)">Carregando…</p>
        ) : (
          <div className="grid gap-8 sm:grid-cols-2 lg:grid-cols-4">
      ...
      <section className="border-t border-[color-mix(in_oklab,var(--lf-ink)_8%,transparent)] bg-(--lf-ink) px-4 py-16 text-center text-(--lf-cream) md:px-8">
        ...
        >
          <Button className="h-12 rounded-none bg-(--lf-cream) px-8 text-[10px] tracking-[0.2em] text-(--lf-ink) uppercase hover:bg-white">
            Chamar no WhatsApp
          </Button>
        </a>
      </section>
