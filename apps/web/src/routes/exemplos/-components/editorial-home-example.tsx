...
export function EditorialHomeExample() {
  ...
  return (
    <div className="store-example-editorial font-ex-body min-h-screen bg-(--ex-bg) text-(--ex-ink)">
      <div className="border-b border-[color-mix(in_oklab,var(--ex-ink)_8%,transparent)] bg-(--ex-bg) px-4 py-2 text-center text-[10px] tracking-[0.2em] text-(--ex-muted) uppercase">
      ...
      <header className="sticky top-0 z-40 border-b border-[color-mix(in_oklab,var(--ex-ink)_6%,transparent)] bg-[color-mix(in_oklab,var(--ex-bg)_94%,white)] backdrop-blur-md">
        <div className="mx-auto grid h-20 max-w-7xl grid-cols-[1fr_auto_1fr] items-center px-4 md:px-8">
          ...
          <Link to="/exemplos/editorial" className="text-center">
            ...
            <span className="mt-0.5 block text-[9px] tracking-[0.28em] text-(--ex-muted) uppercase">
              Moda Praia
            </span>
          </Link>
      ...
      <section className="relative min-h-[85vh] overflow-hidden">
        ...
        />
        <div className="absolute inset-0 bg-linear-to-t from-[color-mix(in_oklab,var(--ex-ink)_55%,transparent)] via-[color-mix(in_oklab,var(--ex-ink)_10%,transparent)] to-transparent" />
        <div className="relative mx-auto flex min-h-[85vh] max-w-7xl items-end px-4 pb-16 md:px-8 md:pb-24">
          <div className="max-w-xl space-y-6 text-white">
            ...
            <div className="flex flex-wrap gap-3 pt-2">
              <button
                type="button"
                className="inline-flex h-12 items-center bg-(--ex-pink) px-8 text-[10px] tracking-[0.2em] uppercase"
              >
                Comprar agora
      ...
      <section className="mx-auto max-w-7xl px-4 py-20 md:px-8">
        <div className="mb-10 flex items-end justify-between">
          <div>
            <p className="text-[10px] tracking-[0.22em] text-(--ex-pink) uppercase">
              Shop by category
            </p>
        ...
        <div className="grid gap-4 md:grid-cols-3">
          {categories.map((category) => (
            ...
            >
              ...
              />
              <div className="absolute inset-0 bg-linear-to-t from-[color-mix(in_oklab,var(--ex-ink)_50%,transparent)] to-transparent" />
      ...
      <section className="border-y border-[color-mix(in_oklab,var(--ex-ink)_6%,transparent)] bg-(--ex-cream-dark) px-4 py-20 md:px-8">
        <div className="mx-auto max-w-7xl">
          ...
          {featuredQuery.isLoading ? (
            <p className="text-(--ex-muted)">Carregando…</p>
          ) : (
                ...
                >
                  <div className="group relative overflow-hidden bg-white">
                    ...
                    >
                      <img
                        src={
                          product.image_url ?? exampleImages.productLifestyle
                        }
                        alt={product.name}
      ...
      <section className="mx-auto grid max-w-7xl items-center gap-10 px-4 py-24 md:grid-cols-2 md:px-8">
        ...
        <div className="space-y-6">
          ...
          <p className="leading-relaxed text-(--ex-muted)">
          ...
          <p className="text-[10px] tracking-[0.18em] text-(--ex-gold) uppercase">
            @BIQUINISLINDAFLOR
          </p>
        </div>
      </section>
